...
namespace Tinyfish.FormatOnSave
{
    ...
    {
        static readonly HashSet<string> TextFileExtensions;
...
.ini;.yaml;.json".Split(';', '\n'));
        ...
        static readonly byte[][] UnicodeBOMs =
        {
        ...
        static bool IsUnicodeFile(FileStream fs)
        {
            var buf = new byte[16];
        ...
        static bool HasBom(byte[] header, byte[] bom)
        {
        ...
        static bool TestBinary(FileStream fs)
        {
            int ch;
